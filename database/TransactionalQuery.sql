-- Nomor 1: Mencari mobil keluaran 2015 ke atas
SELECT * FROM car WHERE year >= 2015;

-- Nomor 2: Menambahkan satu data bid produk baru
INSERT INTO bid (car_id, user_id, date_bid, bid_price, bid_status) VALUES (1,2,'2023-03-04',355500000,'Sent');

-- Nomor 3: Mobil yang dijual oleh akun “Febi Mustofa”
...
-- Nomor 4: Mencari mobil bekas yang termurah berdasarkan keyword "Yaris"
SELECT car_id, brand, model, year, price
FROM Car
WHERE LOWER(model) LIKE '%yaris%'
ORDER BY price ASC;

-- Nomor 5: Mencari mobil bekas yang terdekat berdasarkan sebuah id kota
